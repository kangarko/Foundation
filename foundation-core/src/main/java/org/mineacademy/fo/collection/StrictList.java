...
public final class StrictList<E> extends StrictCollection implements Iterable<E> {
	...
	public void remove(E key) {
		...
		ValidCore.checkBoolean(removed, String.format(this.getCannotRemoveMessage(), key));
	}
	...
	public E remove(int index) {
		...
		ValidCore.checkNotNull(removed, String.format(this.getCannotRemoveMessage(), "index: " + index));
		return removed;
	}
	...
	public void add(E key) {
		ValidCore.checkNotNull(key, "Cannot add null values");
		ValidCore.checkBoolean(!this.list.contains(key), String.format(this.getCannotAddMessage(), key));
	...
	public StrictList<E> range(int startIndex) {
		ValidCore.checkBoolean(startIndex <= this.list.size(), "Start index out of range " + startIndex + " vs. list size " + this.list.size());
	 ...
	 */
	public E first() {
		ValidCore.checkBoolean(!this.list.isEmpty(), "Cannot get first element from an empty list!");
	 ...
	 */
	public E last() {
		ValidCore.checkBoolean(!this.list.isEmpty(), "Cannot get last element from an empty list!");
	...
	public boolean removeWeak(E value) {
		ValidCore.checkNotNull(value, "Cannot remove null values");
	...
	public String join(String separator) {
		return CommonCore.join(this.list, separator);
	}
	...
	public Object serialize() {
		return SerializeUtilCore.serialize(this.getMode(), this.list);
	}
