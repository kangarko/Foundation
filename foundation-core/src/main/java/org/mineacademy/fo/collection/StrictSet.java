...
public final class StrictSet<E> extends StrictCollection implements Iterable<E> {
	...
	public void remove(E value) {
		...
		ValidCore.checkBoolean(removed, String.format(this.getCannotRemoveMessage(), value));
	}
	...
	public void add(E key) {
		...
		ValidCore.checkBoolean(!this.set.contains(key), String.format(this.getCannotAddMessage(), key));
	 ...
	 */
	public E first() {
		ValidCore.checkBoolean(!this.set.isEmpty(), "Cannot get first element from an empty set!");
	...
	public String join(String separator) {
		return CommonCore.join(this.set, separator);
	}
	...
	public Object serialize() {
		return SerializeUtilCore.serialize(this.getMode(), this.set);
	}

	@Override
	public String toString() {
		return "StrictSet{\n\t" + CommonCore.join(this.set, "\n\t") + "\n}";
	}
}