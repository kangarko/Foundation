...
public final class CompChatColor implements TextColor, ConfigStringSerializable {
	...
	static {
		...
		LEGACY_TO_MINI.put("&0", "<reset><black>");
		LEGACY_TO_MINI.put("&1", "<reset><dark_blue>");
		LEGACY_TO_MINI.put("&2", "<reset><dark_green>");
		LEGACY_TO_MINI.put("&3", "<reset><dark_aqua>");
		LEGACY_TO_MINI.put("&4", "<reset><dark_red>");
		LEGACY_TO_MINI.put("&5", "<reset><dark_purple>");
		LEGACY_TO_MINI.put("&6", "<reset><gold>");
		LEGACY_TO_MINI.put("&7", "<reset><gray>");
		LEGACY_TO_MINI.put("&8", "<reset><dark_gray>");
		LEGACY_TO_MINI.put("&9", "<reset><blue>");
		LEGACY_TO_MINI.put("§0", "<reset><black>");
		LEGACY_TO_MINI.put("§1", "<reset><dark_blue>");
		LEGACY_TO_MINI.put("§2", "<reset><dark_green>");
		LEGACY_TO_MINI.put("§3", "<reset><dark_aqua>");
		...
		LEGACY_TO_MINI.put("&a", "<reset><green>");
		LEGACY_TO_MINI.put("&b", "<reset><aqua>");
		LEGACY_TO_MINI.put("&c", "<reset><red>");
		LEGACY_TO_MINI.put("&d", "<reset><light_purple>");
		LEGACY_TO_MINI.put("&e", "<reset><yellow>");
		LEGACY_TO_MINI.put("&f", "<reset><white>");
		LEGACY_TO_MINI.put("&A", "<reset><green>");
		LEGACY_TO_MINI.put("&B", "<reset><aqua>");
		LEGACY_TO_MINI.put("&C", "<reset><red>");
		LEGACY_TO_MINI.put("&D", "<reset><light_purple>");
