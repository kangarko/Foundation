...
public final class RangedSimpleTime implements ConfigStringSerializable {
	...
	public int getRandomTicks() {
		return RandomUtil.nextIntBetween(this.min.getTimeTicks(), this.max.getTimeTicks());
	}
	...
	public int getRandomSeconds() {
		return RandomUtil.nextIntBetween((int) this.min.getTimeSeconds(), (int) this.max.getTimeSeconds());
	}
