...
/**
 * Represents a single rule in the rule set used in plugins such as ChatControl or Protect.
 */
public interface Rule {
	 ...
	 *
	 * You can use {@link CommonCore#joinRange(int, String[])} to join the message together.
	 *
	 * @param rule
	 * @param args
	 *
