...
public final class CompMonsterEgg {
	...
	private static EntityType getTypeByNbt(@NonNull final ItemStack item) {
		try {
			final Class<?> NMSItemStackClass = Remain.getNMSClass("ItemStack", "net.minecraft.world.item.ItemStack");
			final Class<?> craftItemStackClass = Remain.getOBCClass("inventory.CraftItemStack");
