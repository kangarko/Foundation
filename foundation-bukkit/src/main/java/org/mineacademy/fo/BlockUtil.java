...
public final class BlockUtil {
	...
	/*
	 * Get the minimum point of the given two locations
	 */
	...
	/*
	 * Get the maximum point of the given two locations
	 */
	...
	/*
	 * Get the height of the given two locations
	 */
	...
	public static FallingBlock shootBlock(final Block block, final Vector velocity) {
		return shootBlock(block, velocity, 0D, false);
	}
	 ...
	 * and can even make the block burn on impact. The shot block is set to air
	 *
	 * Velocity is randomized a bit for more realism if randomVelocity is true.
	 *
	 * @param block
	 * @param velocity
	 * @param burnOnFallChance from 0.0 to 1.0
	 * @param randomVelocity
	 *
	 * @return
	 */
	public static FallingBlock shootBlock(final Block block, final Vector velocity, final double burnOnFallChance, final boolean randomVelocity) {
		...
		// Apply velocity
		falling.setVelocity(randomVelocity ? new Vector(x, y, z) : velocity);
