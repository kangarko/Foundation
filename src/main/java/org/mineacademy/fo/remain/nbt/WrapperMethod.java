...
enum WrapperMethod {
	...
	COMPOUND_GET_TYPE(WrapperClass.NMS_NBTTAGCOMPOUND.getClazz(), new Class[] { String.class }, V.v1_8, new Since(V.v1_8, "b"), new Since(V.v1_9, "d")), //FIXME: No Spigot mapping!
