...
enum WrapperReflection {
	...
	COMPOUND_MERGE(WrapperClass.NMS_NBTTAGCOMPOUND.getClazz(), new Class[] { WrapperClass.NMS_NBTTAGCOMPOUND.getClazz() }, WrapperVersion.MC1_7_R4, new Since(WrapperVersion.MC1_7_R4, "a")), //FIXME: No Spigot mapping!
	...
	LIST_REMOVE_KEY(WrapperClass.NMS_NBTTAGLIST.getClazz(), new Class[] { int.class }, WrapperVersion.MC1_7_R4, new Since(WrapperVersion.MC1_7_R4, "a"), new Since(WrapperVersion.MC1_9_R1, "remove")),
	LIST_SIZE(WrapperClass.NMS_NBTTAGLIST.getClazz(), new Class[] {}, WrapperVersion.MC1_7_R4, new Since(WrapperVersion.MC1_7_R4, "size")),
	LIST_SET(WrapperClass.NMS_NBTTAGLIST.getClazz(), new Class[] { int.class, WrapperClass.NMS_NBTBASE.getClazz() }, WrapperVersion.MC1_7_R4, new Since(WrapperVersion.MC1_7_R4, "a"), new Since(WrapperVersion.MC1_13_R1, "set")),
	...
	LIST_GET(WrapperClass.NMS_NBTTAGLIST.getClazz(), new Class[] { int.class }, WrapperVersion.MC1_7_R4, new Since(WrapperVersion.MC1_7_R4, "g"), new Since(WrapperVersion.MC1_9_R1, "h"), new Since(WrapperVersion.MC1_12_R1, "i"), new Since(WrapperVersion.MC1_13_R1, "get")),
	...
	NMS_WORLD_GET_TILEENTITY(WrapperClass.NMS_WORLDSERVER.getClazz(), new Class[] { WrapperClass.NMS_BLOCKPOSITION.getClazz() }, WrapperVersion.MC1_7_R4, new Since(WrapperVersion.MC1_7_R4, "getTileEntity")),
	NMS_WORLD_SET_TILEENTITY(WrapperClass.NMS_WORLDSERVER.getClazz(), new Class[] { WrapperClass.NMS_BLOCKPOSITION.getClazz(), WrapperClass.NMS_TILEENTITY.getClazz() }, WrapperVersion.MC1_7_R4, new Since(WrapperVersion.MC1_7_R4, "setTileEntity")),
	NMS_WORLD_REMOVE_TILEENTITY(WrapperClass.NMS_WORLDSERVER.getClazz(), new Class[] { WrapperClass.NMS_BLOCKPOSITION.getClazz() }, WrapperVersion.MC1_7_R4, new Since(WrapperVersion.MC1_7_R4, "t"), new Since(WrapperVersion.MC1_9_R1, "s"), new Since(WrapperVersion.MC1_13_R1, "n"), new Since(WrapperVersion.MC1_14_R1, "removeTileEntity")),
	...
	TILEENTITY_GET_NBT(WrapperClass.NMS_TILEENTITY.getClazz(), new Class[] { WrapperClass.NMS_NBTTAGCOMPOUND.getClazz() }, WrapperVersion.MC1_8_R3, new Since(WrapperVersion.MC1_8_R3, "b"), new Since(WrapperVersion.MC1_9_R1, "save")),
	TILEENTITY_SET_NBT_LEGACY1151(WrapperClass.NMS_TILEENTITY.getClazz(), new Class[] { WrapperClass.NMS_NBTTAGCOMPOUND.getClazz() }, WrapperVersion.MC1_8_R3, WrapperVersion.MC1_15_R1, new Since(WrapperVersion.MC1_8_R3, "a"), new Since(WrapperVersion.MC1_12_R1, "load")),
	...
	NMS_ENTITY_SET_NBT(WrapperClass.NMS_ENTITY.getClazz(), new Class[] { WrapperClass.NMS_NBTTAGCOMPOUND.getClazz() }, WrapperVersion.MC1_8_R3, new Since(WrapperVersion.MC1_8_R3, "f"), new Since(WrapperVersion.MC1_16_R1, "load")), //FIXME: No Spigot mapping!
	NMS_ENTITY_GET_NBT(WrapperClass.NMS_ENTITY.getClazz(), new Class[] { WrapperClass.NMS_NBTTAGCOMPOUND.getClazz() }, WrapperVersion.MC1_8_R3, new Since(WrapperVersion.MC1_8_R3, "e"), new Since(WrapperVersion.MC1_12_R1, "save")),
	...
	GAMEPROFILE_SERIALIZE(WrapperClass.NMS_GAMEPROFILESERIALIZER.getClazz(), new Class[] { WrapperClass.NMS_NBTTAGCOMPOUND.getClazz(), ReflectionUtil.lookupClass("com.mojang.authlib.GameProfile") }, WrapperVersion.MC1_7_R4, new Since(WrapperVersion.MC1_7_R4, "serialize"));
