...
public enum ReflectionMethod {
	...
	GAMEPROFILE_SERIALIZE(ClassWrapper.NMS_GAMEPROFILESERIALIZER.getClazz(), new Class[] { ClassWrapper.NMS_NBTTAGCOMPOUND.getClazz(), ReflectionUtil.lookupClass("com.mojang.authlib.GameProfile") }, MinecraftVersion.MC1_7_R4, new Since(MinecraftVersion.MC1_7_R4, "serialize"));
