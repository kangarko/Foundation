...
public enum CompParticle {
	...
	GEYSER_BASE("GEYSER_BASE", "GEYSER_BASE"),
	GEYSER_PLUME("GEYSER_PLUME", "GEYSER_PLUME"),
	GEYSER_POOF("GEYSER_POOF", "GEYSER_POOF"),
	NOXIOUS_GAS("NOXIOUS_GAS", "NOXIOUS_GAS"),
	NOXIOUS_GAS_CLOUD("NOXIOUS_GAS_CLOUD", "NOXIOUS_GAS_CLOUD"),
	SULFUR_BUBBLES("SULFUR_BUBBLES", "SULFUR_BUBBLES"),
	SULFUR_CUBE_GOO("SULFUR_CUBE_GOO", "SULFUR_CUBE_GOO"),

	// Up to Minecraft 26.3
	ORANGE_POPLAR_LEAVES("ORANGE_POPLAR_LEAVES", "ORANGE_POPLAR_LEAVES"),
	RED_POPLAR_LEAVES("RED_POPLAR_LEAVES", "RED_POPLAR_LEAVES"),
	YELLOW_POPLAR_LEAVES("YELLOW_POPLAR_LEAVES", "YELLOW_POPLAR_LEAVES");
