...
public final class Common extends CommonCore {
	 ...
	 * @param messages
	 */
	public static void tell(@NonNull final ProxiedPlayer player, final String... messages) {
	 ...
	 * @param message
	 */
	public static void tell(@NonNull final ProxiedPlayer player, final SimpleComponent message) {
