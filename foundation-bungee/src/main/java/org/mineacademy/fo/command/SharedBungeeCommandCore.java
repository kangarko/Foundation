...
public interface SharedBungeeCommandCore {
	 ...
	 */
	default ProxiedPlayer findPlayer(final String name) throws CommandException {
	 ...
	 * @throws CommandException
	 */
	default ProxiedPlayer findPlayerOrSelf(final String name) throws CommandException {
		if (name == null) {
